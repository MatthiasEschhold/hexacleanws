...
public class TestConstants {
    ...
    public static final String VIN = "WP0ZZZ99ZTS392155";
    public static final String ADAPTER_IN = "..adapter.in..";
    public static final String ADAPTER = "..adapter..";
    public static final String USECASE = "..usecase..";
    public static final String USECASE_IN = "..usecase.in..";
    ...
    public static final double MILEAGE_TEST_VALUE = 100000;
    public static final String REGISTRATION_COUNTRY_TEST_VALUE = "DE-de";
